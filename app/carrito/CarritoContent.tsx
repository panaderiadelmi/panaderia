...
export default function CarritoContent({ tiendaActiva }: { tiendaActiva: boolean }) {
          ...
          <aside className={`glass-card ${styles.summary}`}>
            ...
            {tiendaActiva ? (
              ...
              <div style={{
                ...
                <p style={{ color: 'var(--color-error)', fontWeight: 600, fontSize: '0.85rem', marginBottom: '4px' }}>
                  Tienda temporalmente cerrada
                </p>
                <p style={{ color: 'var(--color-text-4)', fontSize: '0.78rem', margin: 0 }}>
                  Los pedidos online no están disponibles en este momento.
                </p>
              </div>
            )}
